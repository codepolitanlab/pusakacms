<?php if(! empty($pages)):
	foreach($pages as $uri => $content):
		if($uri != '_title'): ?>
    <li data-title="<?php echo $content['_title']; ?>" data-url="<?php echo $uri; ?>" class="dd-item dd3-item">
        ...
        <div class="dd3-content">
            ...
            <small><a href="<?php echo site_url($uri); ?>" target="_blank" class="page-url"><?php echo $uri; ?></a></small>
