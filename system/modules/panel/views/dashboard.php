		...
		<div class="col-md-8">
			<div class="panel-button-wrapper">
				<div class="row">
					...
					<div class="col-sm-3 col-xs-6">
						<a href="#" class="btn btn-block btn-dashboard">
							<div class="btn-icon"><span class="fa fa-file-image-o"></span></div>
							<div class="btn-label">Upload File</div>
						</a>
					</div>
					<div class="col-sm-3 col-xs-6">
						<a href="#" class="btn btn-block btn-dashboard" title="Export to HTML5 Static">
							<div class="btn-icon"><span class="fa fa-file-code-o"></span></div>
