...
$upload_dir = '/media/'.SITE_SLUG.'/files/'; // path from base_url to base of upload folder (with start and final /)
$current_path = 'media/'.SITE_SLUG.'/files/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = 'media/'.SITE_SLUG.'/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
