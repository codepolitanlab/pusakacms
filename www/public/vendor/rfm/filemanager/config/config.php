<?php
session_save_path($_SERVER['DOCUMENT_ROOT'].'/pusakacms/system/application/sessions');
session_start();

if(! isset($_SESSION['site_slug']))
	die("You don't have permission to access this page.");

$site_slug = isset($_GET['site']) ? $_GET['site'] : $_SESSION['site_slug'];
...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => '/pusakacms/www/media/'.$site_slug.'/files/',
	...
	|
	*/
	'current_path' => '../../../../media/'.$site_slug.'/files/',
